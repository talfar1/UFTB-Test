...
Browser("Google").Navigate "http://mc-nightly-server-10.myd.swinfra.net:8080/" @@ hightlight id_;_4654654_;_script infofile_;_ZIP::ssf1.xml_;_
wait 5
Browser("Google").Page("Login - UFT Mobile").WebEdit("WebEdit").Set "admin@default.com" @@ script infofile_;_ZIP::ssf2.xml_;_
wait 2
