/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘API-TEST1.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{Step.OutputProperties.StartActivity1.flight_from}</DepartureCity><ArrivalCity>{Step.OutputProperties.StartActivity1.flight_to}</ArrivalCity><FlightDate>2022-02-22T00:00:00+02:00</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi23 = new VTDPropertyInfoBase("ExecutionInputParameters","/*[local-name(.)='Arguments'][1]/*[local-name(.)='flight_from'][1]");
            VTDBaseGetter binding_getter12 = new VTDXPathGetter(pi23,XmlTypeCode.String);
            VTDPropertyInfoBase pi24 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter12 = new VTDXPathSetter(pi24,XmlTypeCode.String);
            binding_setter12 = new StringFormaterDecorator(binding_setter12,"{Step.OutputProperties.StartActivity1.flight_from}");
            bind_dir12 = new BindDirection(_flow.StartActivity1,binding_getter12,binding_setter12,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir12);
            VTDPropertyInfoBase pi25 = new VTDPropertyInfoBase("ExecutionInputParameters","/*[local-name(.)='Arguments'][1]/*[local-name(.)='flight_to'][1]");
            VTDBaseGetter binding_getter13 = new VTDXPathGetter(pi25,XmlTypeCode.String);
            VTDPropertyInfoBase pi26 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter13 = new VTDXPathSetter(pi26,XmlTypeCode.String);
            binding_setter13 = new StringFormaterDecorator(binding_setter13,"{Step.OutputProperties.StartActivity1.flight_to}");
            bind_dir13 = new BindDirection(_flow.StartActivity1,binding_getter13,binding_setter13,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir13);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>{Step.OutputProperties.StartActivity1.name}</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity4.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>5</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi27 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][{Array0}]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseGetter binding_getter14 = new VTDXPathGetter(pi27,XmlTypeCode.Int);
            binding_getter14 = new XPathGetterDecorator(binding_getter14,"{Array0}",1);
            VTDPropertyInfoBase pi28 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='FlightNumber'][1]");
            ...
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir14);
            VTDPropertyInfoBase pi29 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='FlightDate'][1]");
            VTDBaseGetter binding_getter15 = new VTDXPathGetter(pi29,XmlTypeCode.DateTime);
            VTDPropertyInfoBase pi30 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='DepartureDate'][1]");
            VTDBaseSetter binding_setter15 = new VTDXPathSetter(pi30,XmlTypeCode.DateTime);
            bind_dir15 = new BindDirection(_flow.StServiceCallActivity4,binding_getter15,binding_setter15,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir15);
            VTDPropertyInfoBase pi31 = new VTDPropertyInfoBase("ExecutionInputParameters","/*[local-name(.)='Arguments'][1]/*[local-name(.)='name'][1]");
            VTDBaseGetter binding_getter16 = new VTDXPathGetter(pi31,XmlTypeCode.String);
            VTDPropertyInfoBase pi32 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='CustomerName'][1]");
            VTDBaseSetter binding_setter16 = new VTDXPathSetter(pi32,XmlTypeCode.String);
            binding_setter16 = new StringFormaterDecorator(binding_setter16,"{Step.OutputProperties.StartActivity1.name}");
            bind_dir16 = new BindDirection(_flow.StartActivity1,binding_getter16,binding_setter16,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity5.InDirections.Add(bind_dir16);
